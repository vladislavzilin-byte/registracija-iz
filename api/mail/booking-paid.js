...
const translations = {
  lt: { title: "Apmokėjimas gautas!", greeting: "Sveiki", text: "Jūsų rezervacija dabar pilnai apmokėta.", data: "Data", laikas: "Laikas", suma: "Suma", kvitas: "Kvitą galite atsisiųsti savo paskyroje" },
  ru: { title: "Оплата получена!", greeting: "Здравствуйте", text: "Ваша запись теперь полностью оплачена.", data: "Дата", laikas: "Время", suma: "Сумма", kvitas: "Квитанцию можно скачать в личном кабинете" },
  en: { title: "Payment received!", greeting: "Hello", text: "Your booking is now fully paid.", data: "Date", laikas: "Time", suma: "Amount", kvitas: "You can download the receipt in your account" },
};
