...
<div class='wrap'>
<h1>${t("finance_report_title")} — ${rangeLabel}</h1>
<table><thead><tr>
<th>${t("date")}</th>
<th>${t("time")}</th>
<th>${t("description")}</th>
...
${combinedItems.map(i=>`<tr>
<td>${i.dateDisplay}</td>
<td>${i.timeDisplay}</td>
<td>${i.description||""}</td>
<td>€${i.amount.toFixed(2)}</td>
<td>€${i.expense.toFixed(2)}</td>
</tr>`).join("")}
</tbody></table></div>
    ...
    <div style={wrapStyle}>
      ...
      <div style={summaryGrid}>
        <div style={summaryCard}>
          <div style={summaryTitle}>{t("finance_system")}</div>
          <div style={summaryValue}>€{systemTotal.toFixed(2)}</div>
          <div style={summaryCaption}>{t("finance_system_caption")}</div>
        </div>
        <div style={summaryCard}>
          <div style={summaryTitle}>{t("finance_manual")}</div>
          <div style={summaryValue}>€{manualTotal.toFixed(2)}</div>
          <div style={summaryCaption}>{t("finance_manual_caption")}</div>
        </div>
        <div style={summaryCard}>
          <div style={summaryTitle}>{t("finance_expenses")} ({percent}%)</div>
          <div style={summaryValue}>€{totalExpenses.toFixed(2)}</div>
          <div style={summaryCaption}>{t("finance_expenses_caption")}</div>
        </div>
        <div style={summaryCard}>
          <div style={summaryTitle}>{t("finance_balance")}</div>
          <div style={summaryValue}>€{balance.toFixed(2)}</div>
          <div style={summaryCaption}>{t("finance_balance_caption")}</div>
        </div>
      </div>
