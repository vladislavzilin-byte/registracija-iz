...
export default function FinancePanel({
  ...
  const editManual = (item) => {
    ...
    if (!entry) return;
    const newDesc = window.prompt(t("finance_edit_desc"), entry.description || "");
    if (newDesc === null) return;
    const newAmountStr = window.prompt(t("finance_edit_amount"), String(entry.amount));
        ...
        <div class="shell">
          ...
          <div class="content">
            ...
            <div class="summary">
              ...
              <div class="card">
                <div class="card-title">${t("finance_expenses")} (${percent}%)</div>
              ...
              <div class="card">
                ...
                <div class="card-caption">${t("finance_balance_caption")}</div>
              </div>
            </div>
            <h2>${t("finance_list_title")}</h2>
            <table>
              <thead>
                <tr>
                  ...
                  <th>${t("description")}</th>
                  <th style="width:80px;">${t("amount")}</th>
                  <th style="width:80px;">${t("expenses")}</th>
                  <th style="width:80px;">${t("receipt_id")}</th>
                </tr>
              </thead>
              <tbody>
                ${
    ...
    <div style={wrapStyle}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        >
          ...
          <div>
            <div style={{ fontWeight: 600 }}>{t("finance_expenses")} ({percent}%)</div>
      ...
      <div>
        <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 4 }}>
          {t("finance_add_manual")}
        </div>
        <div style={{ fontSize: 12, opacity: 0.7, marginBottom: 8 }}>
          {t("finance_manual_add_caption")}
        </div>
        <div
          style={{
            display: "grid",
