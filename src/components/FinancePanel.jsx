      ...
      <head>
        ...
        <style>
          * { box-sizing: border-box; }
          ...
          .header-right b { font-size: 13px; }

          .content { padding: 16px 22px 22px 22px; font-size: 13px; color: #0f172a; }
          .intro { font-size: 12px; color: #4b5563; margin-bottom: 10px; }
          ...
          h2 { font-size: 14px; margin: 6px 0 6px 0; }
          ...
          @media print {
            ...
            .shell { box-shadow: none; border-radius: 0; border: none; }
          }
        </style>
      </head>
          ...
          <div class="header">
            <div class="header-left">
              ...
              <div class="header-title">
                <div class="header-title-main">${settings.masterName || "IZ HAIR TREND"}</div>
                <div class="header-title-sub">Finansų ataskaita pagal laikotarpį</div>
              </div>
            </div>
            <div class="header-right">
              <b>${rangeLabel}</b><br/>Laikotarpis
            </div>
          </div>

          <div class="content">
            <div class="intro">
              Pajamų suvestinė pagal pasirinktas datas.
            </div>
            ...
            <div class="summary">
              ...
              <div class="card">
                ...
                <div class="card-caption">Automatinės išlaidos</div>
              </div>
                  ...
                  groupedByDate.length === 0
                    ...
                    : groupedByDate
                        .map((g) =>
                          g.items
                            .map((item, idx) => {
                              const kv = item.type === "system" ? item.shortId : "";
                              const dateCell = idx === 0 ? g.dateDisplay : "";
                              return `
                                <tr>
                                  <td>${dateCell}</td>
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    background:
                      mode === o.v ? "rgba(248,250,252,0.95)" : "transparent",
