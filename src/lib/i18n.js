...
auth_enter_code: "Введите код из email",
auth_verify_code: "Подтвердить код",
auth_new_password: "Новый пароль",
auth_set_new_password: "Сохранить пароль",
auth_password_changed: "Пароль успешно изменён!",

auth_err_email: "Введите корректный email",
auth_err_code_required: "Введите код",
auth_err_code_wrong: "Неверный код",
auth_err_code_expired: "Срок действия кода истек",
auth_err_unknown: "Ошибка. Попробуйте позже",
auth_recover_title: "Восстановление пароля",
auth_enter_phone: "Введите номер телефона",
auth_show_password: "Показать пароль",
auth_err_phone: "Введите телефон",
auth_err_email: "Неверный email",
auth_err_pwd_short: "Пароль Минимум 6 символов",
auth_err_pwd_match: "Пароли не совпадают",
...
auth_recover_title: 'Восстановление пароля',
auth_reset_step1_text: 'Введите телефон или email, с которым вы регистрировались. Мы отправим код на ваш email.',
auth_reset_step2_text: 'Введите код из письма и новый пароль.',
auth_user_not_found: 'Пользователь не найден',
auth_no_email_for_reset: 'Для восстановления в профиле должен быть указан email.',
auth_code_sent: 'Код отправлен на вашу почту.',
auth_send_error: 'Не удалось отправить код. Попробуйте позже.',
auth_err_code_required: 'Введите код из письма',
auth_sending: 'Отправляем...',
auth_send_code: 'Отправить код',
auth_enter_code: 'Код из письма',
auth_checking: 'Проверяем...',
auth_change_password: 'Изменить пароль',
auth_reset_success: 'Пароль успешно изменён',
auth_invalid_or_expired_code: 'Неверный или истёкший код',
auth_err_name: 'Введите имя',
auth_err_phone: 'Введите телефон',
auth_err_email: 'Некорректный email',
auth_err_pwd_short: 'Минимум 6 символов',
auth_err_pwd_match: 'Пароли не совпадают',
auth_err_identifier: 'Введите телефон или email',
auth_err_enter_password: 'Введите пароль',
auth_err_invalid_login: 'Неверный логин или пароль',
...
auth_account_created: 'Аккаунт создан',
     ...
     auth_wait_30sec: "Подождите 30 секунд перед повторной отправкой кода.",
forgot_password: 'Забыли пароль?',
...
finance_no_records: 'Нет записей за выбранный период',
    ...
    calendar_select_service_error: 'Выберите хотя бы одну услугу.',
    ...
    // Модалка
    calendar_modal_title: 'Выберите услуги',
    calendar_modal_caption: 'Длительность и сумма зависят от выбранных услуг.',
    calendar_modal_instruction: 'Выберите одну или несколько услуг:',
    calendar_deposit: 'Аванс',

    // Блок цен
    calendar_prices_title: 'Цены',
    calendar_prices_toggle: 'Посмотреть цены',

    calendar_price1_price: '80–130 €',
    calendar_price1_title: 'Цена причёски',
    calendar_price1_text: 'Зависит от объёма работы',

    calendar_price2_price: '25 €',
    calendar_price2_title: 'Консультация',
    calendar_price2_text: 'Длится от 30 минут до часа',

    calendar_price3_price: 'Депозит 50 € / 100 €',
    calendar_price3_title: 'Аренда трессов',
    calendar_price3_text:
      'Вернуть в течение 3–4 дней. Вы возвращаете волосы — я возвращаю депозит.',

    calendar_price4_price: 'До 20 €',
    calendar_price4_title: 'Аренда украшений',
    calendar_price4_text: '',

    calendar_price5_price: '130 €',
    calendar_price5_title: 'Выезд в Клайпеде',
    calendar_price5_text:
      'Сборы, переезды — за это время я могла бы принять другую клиентку.',

    // Названия услуг
    service_hair: 'Причёска',
    service_extensions_rent: 'Аренда трессов',
    service_jewelry_rent: 'Аренда украшений',
    service_arrival: 'Выезд',
...
auth_wait_30sec: "Palaukite 30 sekundžių prieš siunčiant kodą dar kartą.",
auth_recover_title: "Slaptažodžio atkūrimas",
auth_enter_phone: "Įveskite telefono numerį",
auth_show_password: "Rodyti slaptažodį",
auth_err_phone: "Įveskite telefoną",
auth_err_email: "Neteisingas el. paštas",
auth_err_pwd_short: "Slaptažodis Mažiausiai 6 simboliai",
auth_err_pwd_match: "Slaptažodžiai nesutampa",
...
auth_reset_step1_text: "Įveskite telefoną arba el. paštą, su kuriuo registravotės. Išsiųsime kodą į jūsų el. paštą.",
auth_reset_step2_text: "Įveskite gautą kodą ir naują slaptažodį.",
auth_no_email_for_reset: "Profilio atkūrimui būtinas el. paštas.",
auth_code_sent: "Kodas išsiųstas į jūsų el. paštą.",
auth_code_sent_to: "Kodas išsiųstas adresu",
auth_send_error: "Nepavyko išsiųsti kodo. Bandykite dar kartą.",
auth_invalid_or_expired_code: "Neteisingas arba pasibaigusio galiojimo kodas.",
auth_reset_success: "Slaptažodis sėkmingai pakeistas!",
auth_sending: "Siunčiama...",
auth_checking: "Tikrinama...",
...
password_confirm: "Patvirtinkite slaptažodį",
    ...
    mb_status_paid: 'Apmokėta',
    mb_status_unpaid: 'Neapmokėta',
    mb_pay_button: 'Apmokėti',
    mb_download_receipt: 'Atsisiųsti kvitą',
...
finance_no_records: 'Nėra įrašų pasirinktame laikotarpyje',
    ...
    processing: 'Vykdoma...',
    reserved_label: 'Užimta',

    cannot_book_past: 'Negalima rezervuoti praeityje.',
    already_booked: 'Šis laikas jau užimtas.',
    calendar_select_service_error: 'Pasirinkite bent vieną paslaugą.',

    weekday_mon_short: 'Pr',
    weekday_tue_short: 'An',
    weekday_wed_short: 'Tr',
    weekday_thu_short: 'Kt',
    weekday_fri_short: 'Pn',
    weekday_sat_short: 'Št',
    weekday_sun_short: 'Sk',

    calendar_modal_title: 'Pasirinkite paslaugas',
    calendar_modal_caption: 'Trukmė ir suma priklauso nuo pasirinktų paslaugų.',
    calendar_modal_instruction: 'Pasirinkite vieną ar kelias paslaugas:',
    calendar_deposit: 'Avansas',

    calendar_prices_title: 'Kainos',
    calendar_prices_toggle: 'Žiūrėti kainas',

    calendar_price1_price: '80–130 €',
    calendar_price1_title: 'Šukuosenos kaina',
    calendar_price1_text: 'Priklauso nuo darbo apimties',

    calendar_price2_price: '25 €',
    calendar_price2_title: 'Konsultacija',
    calendar_price2_text: 'Užtrunkame nuo 30 min. iki valandos',

    calendar_price3_price: '50 € užstatas / 100 €',
    calendar_price3_title: 'Plaukų tęsų nuoma',
    calendar_price3_text:
      'Grąžinti per 3–4 dienas. Grąžinus plaukus – grąžinu užstatą.',

    calendar_price4_price: 'Iki 20 €',
    calendar_price4_title: 'Papuošalų nuoma',
    calendar_price4_text: '',

    calendar_price5_price: '130 €',
    calendar_price5_title: 'Atvykimas Klaipėdoje',
    calendar_price5_text:
      'Daiktų kraustymai, važiavimai — per tą laiką galiu priimti kitą klientę.',

    service_hair: 'Šukuosena',
    service_extensions_rent: 'Tresų nuoma',
    service_jewelry_rent: 'Papuošalų nuoma',
    service_arrival: 'Atvykimas',
    service_consultation: 'Konsultacija',
...
auth_wait_30sec: "Please wait 30 seconds before requesting a new code.",
auth_recover_title: "Password recovery",
auth_enter_phone: "Enter phone number",
auth_show_password: "Show password",
auth_err_phone: "Enter phone number",
auth_err_email: "Invalid email",
auth_err_pwd_short: "Password Minimum 6 characters",
...
auth_reset_step1_text: "Enter the phone or email you registered with. We will send a code to your email.",
auth_reset_step2_text: "Enter the code from the email and your new password.",
auth_no_email_for_reset: "Email must be added in the profile to reset password.",
auth_code_sent: "Code has been sent to your email.",
auth_code_sent_to: "Code sent to",
auth_send_error: "Failed to send the code. Try again.",
auth_invalid_or_expired_code: "Invalid or expired code.",
auth_reset_success: "Password successfully changed!",
...
password_confirm: "Confirm password",
    ...
    mb_pay_button: 'Pay',
    mb_download_receipt: 'Download receipt',
...
finance_no_records: 'No records for the selected period',
    ...
    cannot_book_past: 'You cannot book a past time.',
    already_booked: 'This time is already booked.',
    calendar_select_service_error: 'Select at least one service.',
    ...
    calendar_modal_title: 'Select services',
    calendar_modal_caption: 'Duration and price depend on selected services.',
    calendar_modal_instruction: 'Select one or more services:',
    calendar_deposit: 'Deposit',

    calendar_prices_title: 'Prices',
    calendar_prices_toggle: 'View prices',

    calendar_price1_price: '80–130 €',
    calendar_price1_title: 'Hairstyle price',
    calendar_price1_text: 'Depends on work complexity',

    calendar_price2_price: '25 €',
    calendar_price2_title: 'Consultation',
    calendar_price2_text: 'Takes from 30 min to 1 hour',

    calendar_price3_price: 'Deposit 50 € / 100 €',
    calendar_price3_title: 'Hair extensions rental',
    calendar_price3_text:
      'Must be returned within 3–4 days. Return the hair — deposit is refunded.',

    calendar_price4_price: 'Up to 20 €',
    calendar_price4_title: 'Jewelry rental',
    calendar_price4_text: '',

    calendar_price5_price: '130 €',
    calendar_price5_title: 'Arrival in Klaipėda',
    calendar_price5_text:
      'Travel and preparation — during this time I could serve another client.',

    service_hair: 'Hairstyle',
    service_extensions_rent: 'Hair extensions rental',
    service_jewelry_rent: 'Jewelry rental',
