...
modal_confirm: 'Подтвердить'
  ...
  finance_no_records: 'Нет записей',
...
lt: {
  ...
  /* 🔥 Nauji raktai */
  receipt_pdf_hint: 'Galite išsaugoti šį dokumentą kaip PDF.',
...
en: {
  ...
  mb_payment_link_error: 'Could not get payment link',
  ...
  /* ============================================================
       RECEIPT (Invoice / Payment Document)
  ============================================================ */
  ...
  receipt_footer_text:
    'This receipt is generated automatically and valid without a signature. You can save it as PDF via the browser print menu.',
