...
/* ------------------ admin ------------------ */
    ...
    receipt_subtitle: 'Квитанция за бронирование',
    receipt_number_label: '№',
    receipt_created_label: 'Создана:',
    receipt_qr_hint: 'Отсканируйте, чтобы сохранить контакт',
    ...
    receipt_footer_text:
      'Эта квитанция сформирована автоматически и действует без подписи. При необходимости вы можете сохранить её как PDF через меню печати браузера.',
...
/* ------------------ admin ------------------ */
    ...
    receipt_title: 'Kvitancija',
    receipt_subtitle: 'Kvitancija už rezervaciją',
    receipt_number_label: 'Nr.',
    receipt_created_label: 'Sukurta:',
    receipt_qr_hint: 'Nuskenuokite ir išsaugokite kontaktą',
...
/* ------------------ admin ------------------ */
    ...
    admin_mark_unpaid_button: 'Mark as unpaid',
    admin_mark_paid_button: 'Mark as paid',
    ...
    receipt_subtitle: 'Receipt for booking',
    receipt_number_label: 'No.',
    receipt_created_label: 'Created:',
    receipt_qr_hint: 'Scan to save contact',
